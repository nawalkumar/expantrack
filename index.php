...
<div class="container flex rounded-lg shadow-lg p-5 mb-24   wrap">
        <div class="flex justify-center  p-4  ">
            <img src="include/assets/catogery.jpg" alt="Placeholder Image" class="hover-grow transition-transform duration-300 ease-in-out rounded-lg">
        </div>
        <div class="flex flex-col p-4 hover-grow transition-transform duration-300 ease-in-out rounded-lg">
            <h2 class="text-3xl font-bold mb-4 mt-12 ml-6 text-left ">See you expenses Easily <br> in catogery wise formet</h2>
            <p class="text-gray-700 text-left mt-12 ml-6">boost your productivity to automiting your<br> expenses management process, you can see your expenses details on simple clicks.</p>
        </div>
</div>
<div class="container flex rounded-lg shadow-lg p-5 mb-24   wrap">
        <div class="flex flex-col p-4 hover-grow transition-transform duration-300 ease-in-out rounded-lg">
            <h2 class="text-3xl font-bold mb-4 mt-12 ml-6 text-left ">Easily understnad your expenses <br> from seeing their graphical chart </h2>
            <p class="text-gray-700 text-left mt-12 ml-6">boost your productivity to automiting your<br> expenses management process, you can see your expenses details on simple clicks.</p>
        </div>

        <div class="flex justify-center  p-4  ">
            <img src="include/assets/graphical.jpg" alt="Placeholder Image" class="hover-grow transition-transform duration-300 ease-in-out rounded-lg">
        </div>
</div>
<div class="container flex rounded-lg shadow-lg p-5 mb-24   wrap">
        <div class="flex justify-center  p-4  ">
            <img src="include/assets/alarm.jpg" alt="Placeholder Image" class="hover-grow transition-transform duration-300 ease-in-out rounded-lg">
        </div>
        <div class="flex flex-col p-4 hover-grow transition-transform duration-300 ease-in-out rounded-lg">
            <h2 class="text-3xl font-bold mb-4 mt-12 ml-6 text-left ">Set you appropriate time <br>for reminding you to add  your today expenses </h2>
            <p class="text-gray-700 text-left mt-12 ml-6">boost your productivity to automiting your<br> expenses management process, you can see your expenses details on simple clicks.</p>
        </div>
</div>
